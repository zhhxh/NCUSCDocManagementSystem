...
public interface CourseMapper {
	 ...
	 * */
	@Select("select * from t_course_info")
	 ...
	 * @return Course对象
	 * */
	@Select("select * from t_course_info where cId=#{cId}")
	 ...
	 * @return Course对象
	 * */
    @Select("select * from t_course_info where cName=#{cName}")
